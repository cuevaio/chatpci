...
function IconPCI({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      aria-label="PCI logomark"
      role="img"
      viewBox="0 0 135 47"
      className={cn("size-4", className)}
      {...props}
